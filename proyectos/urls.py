...
urlpatterns = [
    ...
    path("control/organizaciones/<int:pk>/", views.superadmin_organizacion_detalle, name="superadmin_organizacion_detalle"),
    path("control/organizaciones/<int:pk>/editar/", views.superadmin_organizacion_editar, name="superadmin_organizacion_editar"),
    ...
    path("proyectos/crear/<int:pk>/asistente/", views_wizard.wizard_asistente, name="wizard_asistente"),
    path("proyectos/crear/<int:pk>/sugerir-indicadores/", views_wizard.wizard_sugerir_indicadores, name="wizard_sugerir_indicadores"),
    ...
    path("notas/diseno/", views.notas_diseno, name="notas_diseno"),
